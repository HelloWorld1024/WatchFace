...
import java.lang.annotation.RetentionPolicy;
    ...
    public class BoxInsetLayout extends ViewGroup {
        private static final String TAG = "BoxInsetLayout";


        private static final Boolean IS_ROUND = true ; //根据系统屏幕形状设置，手机系统内没有对应配置。　
        ...
        protected void onAttachedToWindow() {
            ...
            mIsRound = IS_ROUND ; // getResources().getConfiguration().isScreenRound();
            Log.i(TAG,"isRound = "+mIsRound) ;
         ...
         * See {@link  BoxInsetLayout Layout Attributes} for a list
